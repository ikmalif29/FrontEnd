...
const Register = () => {
  ...
  return (
    ...
    >
      <div className="relative bg-gray-900 text-white rounded-xl shadow-2xl p-8 w-full max-w-md">
        <div className="absolute -top-12 left-1/2 transform -translate-x-1/2">
          <div className="w-24 h-24 bg-gray-800 rounded-full flex items-center justify-center shadow-lg border-4 border-green-400">
            <UserPlus className="text-green-400" size={48} />
          </div>
        </div>

        <h2 className="text-center text-xl font-semibold mb-8 mt-16">
          Create an Account
        </h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              ...
              required
              className="w-full p-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-400"
            />
          </div>
          <div className="mb-6">
